...
if admin_username == "admin":
    otp = otp.send_otp("sairutwika1408@gmail.com")
...
userdetails = {
    101 : ["sai rutwika","rutwikaelluru@gmail.com","false"],
    102 : ["pavani","killana.pavani01@gmail.com","false"],
    103 : ["Apsara","apsarasyed267@gmail.com","true"],
    }
print("Welcome Admin")
while True:
